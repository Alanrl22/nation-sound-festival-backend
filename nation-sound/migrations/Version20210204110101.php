...
final class Version20210204110101 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, meeting_id INT DEFAULT NULL, music_style_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, big_artist TINYINT(1) NOT NULL, INDEX IDX_159968767433D9C (meeting_id), INDEX IDX_15996877DDE3C52 (music_style_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE concert (id INT AUTO_INCREMENT NOT NULL, artist_id INT DEFAULT NULL, stage_id INT DEFAULT NULL, active TINYINT(1) NOT NULL, day VARCHAR(255) DEFAULT NULL, hour INT DEFAULT NULL, INDEX IDX_D57C02D2B7970CF8 (artist_id), INDEX IDX_D57C02D22298D193 (stage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE meeting (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, coordinates VARCHAR(255) NOT NULL, hour INT DEFAULT NULL, day VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
