 ...
 */
final class Version20210203220809 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE restauration ADD category_id INT NOT NULL, DROP category');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE restauration ADD category VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP category_id');
    }
}
